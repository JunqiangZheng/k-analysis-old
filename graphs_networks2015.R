...
# result_analysis <- analyze_network("M_PL_017.csv", directory = "data/", guild_a = "Plant", guild_b = "Pollinator", plot_graphs = TRUE)
# bp <- get_bipartite(result_analysis$graph, plot_graphs = TRUE)
# plot_bipartite(bp, aspect_ratio = 9/40,vlabelcex=5,vsize = 3.5, vframecolor = "grey40", color_link = "black")
