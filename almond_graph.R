...
while (nrow(weirds_a)>0)
{
  ...
  xcoord <- last_xtail_b[coreconnect]-ns*2*lado/aspect_ratio
...
while (nrow(weirds_b)>0)
{
  ...
  xcoord <- (4*lado/aspect_ratio)+last_xtail_a[coreconnect]-ns*2*lado/aspect_ratio
  if (coreconnect == kcoremax)
    xcoord <- xcoord-gap/2
