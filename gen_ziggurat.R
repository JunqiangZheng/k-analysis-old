...
#ziggurat_graph("data/","M_PL_002.csv", paintlinks = FALSE, print_to_file = TRUE)
# ziggurat_graph("data/","M_PL_021.csv",  paintlinks = FALSE, flip_results = FALSE,kcore1tail_disttocore = c(9.5,0.5),innertail_vertical_separation =10,kcore2tail_vertical_separation = 4, 
#                               height_box_y_expand =30,factor_hop_x=20,coremax_triangle_height_factor = 2.5,coremax_triangle_width_factor = 1.2,outsiders_separation_expand = 8,aspect_ratio=2.5,
#                               displace_y_a=c(0,0,0,2),displace_y_b=c(0,0,0.45,1.5), fattailjumphoriz = c(3,4),fattailjumpvert = c(-3,-1), lsize_zig = 2,displace_legend = c(-1.5,0.1),
#                               displace_outside_component = c(-1.5,0.8),weirdskcore2_horizontal_dist_rootleaf_expand = 0, weirds_boxes_separation_count=8,weirdskcore2_vertical_dist_rootleaf_expand = 1,root_weird_expand = c(0.5,1),
#                               rescale_plot_area=c(2,1.5))
...
ziggurat_graph("data/","M_PL_057.csv",fattailjumpvert = c(1,0.1),fattailjumphoriz = c(1,3),height_box_y_expand =4,displace_y_a=c(0,0,0,0.2,0.5,1,1.5),
               ...
               rescale_plot_area=c(1,2.5), lsize_zig = 1.5,lsize_kcore1 = 1.5,lsize_kcoremax = 3,print_to_file = TRUE)
end_time <- proc.time()
print(end_time - init_time)

#ziggurat_graph("data/","M_PL_001.csv", innertail_vertical_separation = 1.5, aspect_ratio=0.8,paintlinks=TRUE,coremax_triangle_width_factor = 1.5,kcore1tail_disttocore = c(1.6,1.2), displace_outside_component = c(-0.7,1.2), print_to_file = TRUE)
...
#                displace_y_a=c(0,0,0,0.18,0.2,0.3,0.5),displace_y_b=c(0,-0.5,0.45,0.62,0.67,0.68,0.7), fattailjumpvert = c(1,0.5), lsize_zig = 2.5,
...
#                lsize_zig = 4.5, lsize_kcoreone = 4.5, displace_legend = c(-0.15,0.15), print_to_file = TRUE)
# ziggurat_graph("data/","M_PL_012.csv", aspect_ratio = 1.4, lsize_legend = 5.5, lsize_core_box = 5,lsize_kcoremax = 4.5, 
#                lsize_zig = 4.5, lsize_kcoreone = 4.5, print_to_file = TRUE)
...
#ziggurat_graph("data/","M_PL_016.csv",height_box_y_expand =3,displace_y_a=c(0,0.2,0.25,0.3,0,0,0),0.2,0.3,0,0,0),factor_hop_x=1.5,print_to_file = TRUE)
#ziggurat_graph("data/","M_PL_017.csv", height_box_y_expand =1.5,displace_y_b=c(0,-0.25,0,0,0), print_to_file = TRUE)
#ziggurat_graph("data/","M_PL_018.csv",  height_box_y_expand =1.5,displace_y_a=c(0,0,0,0.2),kcore1tail_disttocore = c(1.1,1.1),factor_hop_x=1.2,print_to_file = TRUE)
...
#                lsize_zig = 4, lsize_kcoreone = 4, aspect_ratio = 0.55, displace_legend = c(-0.1,0.1), print_to_file = TRUE)
...
# ziggurat_graph("data/","M_PL_053.csv", height_box_y_expand =1.5,coremax_triangle_width_factor = 1.5, lsize_kcoremax = 3, 
#                weirds_boxes_separation_count=5, kcore1tail_disttocore = c(2.8,1.4), displace_legend = c(-0.45,0),factor_hop_x=2.5,
#                root_weird_expand = c(1.5,1.5), aspect_ratio=4,innertail_vertical_separation =3,kcore2tail_vertical_separation = 7, 
#                displace_y_b=c(0,-1,0), rescale_plot_area=c(1,1.8), outsiders_separation_expand = 2, displace_outside_component = c(-1,1),
...
# ziggurat_graph("data/","M_PL_054.csv",height_box_y_expand =1.5,lsize_zig = 2.5,innertail_vertical_separation =4,
#                outsiders_separation_expand = 2, coremax_triangle_height_factor = 1.25,
#                kcore2tail_vertical_separation =4,fattailjumphoriz = c(1,1.5),fattailjumpvert = c(1,0.1),kcore1tail_disttocore = c(1.2,1.5),
#                displace_outside_component = c(-0.5,1),weirds_boxes_separation_count = 7,rescale_plot_area=c(1,1.8),weirdskcore2_horizontal_dist_rootleaf_expand = 1.2,
#                kcore1weirds_leafs_vertical_separation=1.2,root_weird_expand = c(1.5,1),print_to_file = TRUE)
...
# ziggurat_graph("data/","M_PL_056.csv", height_box_y_expand =2,lsize_zig = 2,lsize_kcoremax = 3,innertail_vertical_separation = 3,fattailjumpvert = c(1,0.1),fattailjumphoriz = c(1,1.5),
#                kcore2tail_vertical_separation = 5, rescale_plot_area=c(1,1.7), kcore1weirds_leafs_vertical_separation=2,factor_hop_x=1.35,
...
#                displace_y_a=c(0,0,0,0.3),displace_y_b=c(0,0,0.5,0.6),kcore1tail_disttocore = c(2,1.25),print_to_file = TRUE)
